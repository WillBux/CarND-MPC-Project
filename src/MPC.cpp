 ...
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
      ...
      for (int t = 0; t < N - 2; t++) {
          ...
          fg[0] += a_weight * 1e4 * CppAD::pow(vars[a_start + t + 1] - vars[a_start + t], 2);
      }
      ...
      for (int t = 1; t < N; t++) {
          ...
          AD<double> x0sq = x0*x0;
          AD<double> f0 = coeffs[0] + coeffs[1] * x0 + coeffs[2]*x0sq + coeffs[3]*x0sq*x0;
          AD<double> psides0 = CppAD::atan(coeffs[1] + 2*coeffs[2]*x0 + 3*coeffs[3]*x0sq);
